...
/***/ function(module, exports, __webpack_require__) {
	...
	var Hello = __webpack_require__(12);
	var Autocomplete = __webpack_require__(11);
	var sixdegrees = __webpack_require__(13);
	...
	exports.default = {
		...
		methods: {
			change: function change() {
				...
				return this.$http.post('http://localhost:3000/autocomplete', model).then(function (response) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var mapGetters = __webpack_require__(1).mapGetters;
	exports.default = {
	  computed: mapGetters({
	    bands: 'bands'
	  }),
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_options__.functional) {console.error("[vue-loader] SixDegrees.vue: functional components are not supported and should be defined in plain js files using render functions.")}
